        ...
        <div data-section="insp-section-action" style={{ borderBottom: "1px solid var(--line, #1d2b3a)" }}>
          ...
          <div style={{ padding: "4px 12px 10px", display: "flex", flexDirection: "column", gap: "7px" }}>
            {currentAction === undefined ? (
              <button data-testid="action-add" onClick={handleActionAdd} style={{ fontSize: "0.8em" }}>
                + Add action
              </button>
            ) : (
              <>
                ...
                <div>
                  <button data-testid="action-remove" onClick={handleActionRemove} style={{ fontSize: "0.8em" }}>
                    Remove action
                  </button>
                </div>
              </>
      ...
      {isDialType && (
        <div data-section="insp-section-dial" style={{ borderBottom: "1px solid var(--line, #1d2b3a)" }}>
          ...
          <div style={{ padding: "4px 12px 10px", display: "flex", flexDirection: "column", gap: "7px" }}>
              ...
              return (
                <div key={i} data-testid={`marker-row-${i}`} style={{ display: "flex", flexDirection: "column", gap: "3px", border: "1px solid var(--line2, #24364a)", borderRadius: "4px", padding: "5px" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
                    ...
                    <button data-testid={`marker-remove-${i}`} onClick={() => handleMarkerRemove(i)} style={{ fontSize: "0.77em", padding: "2px 5px" }}>×</button>
                  </div>
                  <PathPicker
                    value={dirPath}
                    manifest={manifest}
            ...
            <div>
              <button data-testid="marker-add" onClick={handleMarkerAdd} style={{ fontSize: "0.8em" }}>+ Add marker</button>
            </div>
            ...
            {currentSectors.map((s, i) => (
              <div key={i} data-testid={`sector-row-${i}`} style={{ display: "flex", alignItems: "center", gap: "4px" }}>
                ...
                <button data-testid={`sector-remove-${i}`} onClick={() => handleSectorRemove(i)} style={{ fontSize: "0.77em", padding: "2px 5px" }}>×</button>
              </div>
            ))}
            <div>
              <button data-testid="sector-add" onClick={handleSectorAdd} style={{ fontSize: "0.8em" }}>+ Add sector</button>
            </div>
          </div>
        </div>
      )}
